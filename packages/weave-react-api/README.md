...
```sh
npm install @weavechain/weave-react-api --save
```

or

```sh
yarn add @weavechain/weave-react-api
```
...
```js
import { WeaveAPI, WeaveHelper } from "@weavechain/weave-react-api"
